...
function squareInfo = SquareProp(ref0, ref1)
...
gammaDif = gammaMaxCone - gammaMinCone;
...
thetaDif = thetaMaxCone - thetaMinCone;
thetaMinCone = thetaMinCone - thetaDif;
thetaMaxCone = thetaMaxCone + thetaDif;

%% Generate uniform quadratures for each local refinement level
